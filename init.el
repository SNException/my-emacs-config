...
(custom-set-faces
 '(default ((t (:family "Ubuntu Mono" :foundry "outline" :slant normal :weight normal :height 190 :width normal))))

 '(font-lock-builtin-face ((t (:foreground "#000000"))))
 '(font-lock-comment-face ((t (:foreground "#338833"))))
 ...
 '(mode-line ((t (:background "#999999" :foreground "black"))))
 '(mode-line-inactive ((t (:background "#777777" :foreground "black"))))

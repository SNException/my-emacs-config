...
(custom-set-faces
 '(default ((t (:family "Ubuntu Mono" :foundry "outline" :slant normal :weight normal :height 165 :width normal))))
 ...
 '(font-lock-string-face ((t (:foreground "#ffbbbb"))))
 '(font-lock-type-face ((t (:foreground "gray"))))
 '(font-lock-variable-name-face ((t (:foreground "#ff9595"))))
...
(set-face-foreground 'minibuffer-prompt "#ff7070")
...
(define-key global-map (kbd "C-S-u") 'scroll-down)
